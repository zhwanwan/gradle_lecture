package com.lec.gra.todo.web;

import com.lec.gra.todo.modle.ToDoItem;
import com.lec.gra.todo.repository.InMemoryToDoRepository;
import com.lec.gra.todo.repository.ToDoRepository;
...
public class ToDoServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String servletPath = request.getServletPath(); //获取请求URL的路径；路径以/开头
        String view = processRequest(servletPath, request);
        RequestDispatcher dispatcher = request.getRequestDispatcher(view);
        dispatcher.forward(request, response); //从Servlet转发请求都JSP
    }
